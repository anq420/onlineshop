    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('In process', 'In process'), ('Is in stock', 'Is in stock'), ('On the way', 'On the way'), ('Delivered', 'Delivered'), ('Completed', 'Completed'), ('Refused', 'Refused')], max_length=100)),
                ...
                ('payment_method', models.CharField(choices=[('Card online', 'Card online'), ('Card offline', 'Card offline'), ('Cash', 'Cash')], max_length=250)),
                ('payment_status', models.CharField(choices=[('Paid', 'Paid'), ('In process', 'In process'), ('Cancelled', 'Cancelled')], default='In process', max_length=250)),
                ('delivery_notification_due_to', models.PositiveIntegerField(choices=[(24, 24), (12, 12), (6, 6), (1, 1)], default=6)),
